...
import CardJournaliere from "../Card/CardJournaliere.js";

export function Ventes_journaliere () {
  const [venteJournaliereData, setJournaliereData] = useState([]); 
   // CALENDRIER
  ...
  const onPress = () => {
    ...
    onClick();
    //console.log(venteJournaliereData);
    setShowCard(true);
  };

  const onClick = () => {
    // Construct the base URL
    let apiUrl = 'http://192.168.56.1:3003/ventesJournaliere?';
    ...
    /*if (selectedModeleLabel !== null) {
      queryParams.push(`DATE_FACTURE=${selectedDate}`);
    }*/
  ...
  return (
    <ImageBackground source={require('../assets/greyoff.jpg')} style={styles.backgroundImage}>
      <ScrollView>
        <View style={styles.listitemposition}>
          <View style={styles.listitem}>
            <Dropdown
              ...
              onValueChange={(selected) => {
                //setSelectedGroupementValue(selected);
          ...
          <View style={styles.listitem}>
            <Dropdown
              ...
              onValueChange={(selected) => {
                //setSelectedMarqueValue(selected);
          ...
          <View style={styles.listitem}>
            <Dropdown
              ...
              onValueChange={(selected) => {
                //setSelectedModeleValue(selected);
        ...
        {showCard && (
          <CardJournaliere content={venteJournaliereData} />
        )}
      </ScrollView>
    </ImageBackground>
  );
...
export default Ventes_journaliere;