...
import CardObjectifMicro from '../Card/CardObjectifMicro.js'

export function Objectif_Microservice () {
  const [venteObjectifData, setObjectifData] = useState([]); 
  // CALENDRIER
...
// POUR AFFICHER LA CARD
 ...
 useEffect(() => {
  ...
  const onClick = () => {
    ...
    let apiUrl = 'http://192.168.56.1:3003/objectif?';
  ...
  return(
    ...
    <ScrollView>
      ...
      <TouchableOpacity style={styles.buttonCalendrier} onPress={toggleCalendar}>
        ...
        {showCard && (
          <CardObjectifMicro content={venteObjectifData} />
        )}
        </ScrollView>
    </ImageBackground>
);
...
export default Objectif_Microservice;