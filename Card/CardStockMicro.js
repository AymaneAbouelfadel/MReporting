...
const CardStockMicro = ({ content }) => {
  return (
    <View style={styles.card}>
      <View style={styles.labelParentContainer}>
        <Text style={styles.labelParent}>Stock Microservice</Text>
      </View>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.column}>
          ...
          <Text style={styles.value}>{((content.STMoins30 !== null) ? content.STMoins30 : 0) | 0}</Text>
        </View>

        <View style={styles.column}>
          <Text style={styles.label}>marge</Text>
          <Text style={styles.value}>{((content.STPlus30 !== null) ? content.STPlus30 : 0) | 0}</Text>
        </View>
      </View>
    </View>
);
